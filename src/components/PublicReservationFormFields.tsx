...
interface PublicReservationFormFieldsProps {
  formData: FormData;
  onFormDataChange: (updates: Partial<FormData>) => void;
  disableFranchiseSelect?: boolean;
}

const PublicReservationFormFields: React.FC<PublicReservationFormFieldsProps> = ({
  formData,
  onFormDataChange,
  disableFranchiseSelect = false,
}) => {
  const { franchises, loading: franchisesLoading, error } = useFranchisesPublic();

  console.log('🔍 PublicReservationFormFields - Current state:', {
    franchises,
...
export default PublicReservationFormFields;
